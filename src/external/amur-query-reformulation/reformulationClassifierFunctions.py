...
def classify_to_df(inputFile):
	...
	for line in open(inputFile):
		...
		out_df += [{'type':type,'userId':userId,'timeDiff':int(timeDiff),'urlSame':urlSame,'rankChange':rankChange,'clickPattern':clickPattern}]
